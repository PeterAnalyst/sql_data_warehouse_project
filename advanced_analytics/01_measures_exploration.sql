...
SELECT COUNT(order_number) AS total_orders FROM gold.facts_sales
...
SELECT 'Total Sales' AS measure_name, SUM(sales_amount) AS measure_value FROM gold.facts_sales
UNION ALL
